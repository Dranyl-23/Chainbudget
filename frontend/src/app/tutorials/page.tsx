...
export default function TutorialsPage() {
  return (
    <main className="min-h-screen bg-[#0A0216] text-white">
      ...
      {/* Nav */}
      <nav className="relative z-20 flex items-center justify-between px-6 md:px-12 py-5 border-b border-white/5 backdrop-blur-md bg-black/20">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-white/5 border border-white/10">
            <img src="/images/logo.png" alt="ChainBudget" className="w-6 h-6 object-contain rounded-lg" />
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/dashboard" className="text-sm px-4 py-2 rounded-full bg-fuchsia-600/20 border border-fuchsia-500/30 text-fuchsia-300 hover:bg-fuchsia-600/30 transition-colors">
            Go to Dashboard
          </Link>
        </div>
      </nav>
