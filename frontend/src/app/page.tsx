  ...
  return (
    <main className="min-h-screen flex flex-col relative overflow-hidden bg-[#0A0216] text-white">
      ...
      <nav className="relative z-20 flex items-center justify-between px-8 py-6">
        ...
        <div className="flex items-center gap-2 text-xs text-white/50 bg-white/5 px-4 py-2 rounded-full border border-white/10 backdrop-blur-md">
      ...
      {/* ── Hero ── */}
      <section className="relative z-10 flex flex-col items-start justify-center px-8 md:px-16 pt-20 pb-32 max-w-7xl mx-auto w-full">
        <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold tracking-tight mb-8 leading-[1.05] text-white max-w-4xl drop-shadow-2xl uppercase">
          SIMPLIFY YOUR <br />
      ...
      <section className="relative z-10 px-8 md:px-16 pb-32 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {features.map((f, i) => (
            <div key={i} className="group relative p-8 rounded-3xl bg-[#160B2E]/60 backdrop-blur-xl border border-purple-500/20 overflow-hidden hover:-translate-y-2 hover:border-purple-400/50 hover:bg-[#1a0e35]/80 transition-all duration-500 shadow-[0_0_30px_rgba(139,92,246,0.05)]">
              {/* Inner Glow */}
              ...
              <h3 className="font-bold text-lg text-white mb-3 tracking-wide">{f.title}</h3>
      ...
      {/* ── Stats Banner ── */}
      <section className="relative z-10 px-8 md:px-16 pb-24 max-w-7xl mx-auto w-full">
        <div className="rounded-3xl bg-[#160B2E]/40 backdrop-blur-lg border border-purple-500/20 py-10 px-8 flex flex-col md:flex-row justify-around items-center gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-purple-500/20">
          <div className="flex flex-col items-center px-4 w-full">
            <span className="text-4xl font-bold text-white mb-2">100%</span>
            <span className="text-xs text-white/50 uppercase tracking-widest">On-Chain Transparency</span>
          </div>
          <div className="flex flex-col items-center px-4 w-full pt-6 md:pt-0">
            <span className="text-4xl font-bold text-white mb-2">&lt; 2s</span>
            <span className="text-xs text-white/50 uppercase tracking-widest">Transaction Speed</span>
          </div>
          <div className="flex flex-col items-center px-4 w-full pt-6 md:pt-0">
            <span className="text-4xl font-bold text-white mb-2">Multi-Sig</span>
            <span className="text-xs text-white/50 uppercase tracking-widest">Enterprise Security</span>
          </div>
        </div>
      </section>

      {/* ── Footer ── */}
      <footer className="relative z-10 text-center py-8 text-xs text-white/30 border-t border-white/5 mt-auto bg-[#05010B]/50 backdrop-blur-md">
